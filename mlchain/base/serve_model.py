...
def get_single_funcion(batch_func, variables,variable_names = None, default=None, timeout=-1, name='single_func', max_queue=100,
                       max_batch_size=32):
    if timeout is None or (isinstance(timeout, (float, int)) and timeout <= 0):
        timeout = -1
    else:
